<!-- ################################################################################################ -->
<!-- this is the footer section for the CLS pages -->
<div class="wrapper row5">
  <footer id="footer" class="clear"> 
    <div class="one_quarter first">
      <h6 class="title">Location and Hours</h6>
      <address class="btmspace-15">
      Central Library System<br>
    ...
    <div class="one_quarter">
      ...
      <ul class="nospace linklist">
        <li><a href="CLS-home.php">Home Page</a></li>
    ...
    <div class="one_quarter">
      ...
      <article>
        ...
        <time class="smallfont" datetime="2015-04-02">Thursday, 2<sup>nd</sup> April 2015</time>
        <p>Vestibulumaccumsan egestibulum eu justo convallis augue estas aenean elit intesque sed.</p>
      </article>
    </div>

    <div class="one_quarter">
      <h6 class="title">Get Our Newsletter</h6>
